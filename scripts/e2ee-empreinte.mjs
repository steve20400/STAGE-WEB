/**
 * LANCEUR DU BANC DES CODES DE SÉCURITÉ.
 *
 ...
 *
 * Usage : node scripts/e2ee-empreinte.mjs   (aucun serveur requis)
 */
...
const SORTIE = "scripts/.banc-empreinte";

if (existsSync(SORTIE)) rmSync(SORTIE, { recursive: true, force: true });
console.log("\n⚙  Compilation du scénario par Vite…");
execSync(
  `npx vite build --ssr scripts/e2ee-empreinte-test.js --outDir ${SORTIE} --logLevel error`,
  { stdio: "inherit" },
);

const module = await import(`../${SORTIE}/e2ee-empreinte-test.js`);
