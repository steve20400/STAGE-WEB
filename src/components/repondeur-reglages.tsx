  ...
  return (
    <div className="s-card">
      ...
      <style>{`
        ...
        .repondeur-programmes{margin-top:18px;padding:16px;border:1px solid var(--border-subtle);border-radius:14px;background:var(--bg-elevated);display:grid;gap:12px}.repondeur-programmes h3{margin:0;font-size:14px;font-weight:800;color:var(--text-primary)}.repondeur-programmes p{margin:0;color:var(--text-muted);font-size:11px;line-height:1.45}.rep-program-form{display:grid;grid-template-columns:minmax(0,1.35fr) minmax(90px,1fr) auto minmax(90px,1fr) auto;align-items:center;gap:8px}.rep-program-form select,.rep-program-form input{min-width:0;height:38px;border:1px solid var(--border-subtle);border-radius:9px;background:var(--bg-surface);color:var(--text-primary);padding:0 9px;font:inherit;font-size:12px}.rep-program-form span{color:var(--text-muted);font-size:12px;text-align:center}.rep-program-form button{height:38px;white-space:nowrap}.rep-program-row{display:grid;grid-template-columns:minmax(0,1fr) auto auto auto;align-items:center;gap:8px;padding:9px 0;border-top:1px solid var(--border-subtle);font-size:12px;color:var(--text-primary)}.rep-program-row small{color:var(--text-muted);font-size:10px}.rep-program-row .rep-btn{padding:7px 9px;font-size:11px}.rep-btn-ghost{background:var(--bg-surface)!important;color:var(--text-secondary)!important;border-color:var(--border-subtle)!important}.rep-program-row .rep-btn:last-child{color:var(--danger)!important}@media(max-width:600px){.repondeur-programmes{padding:13px}.rep-program-form{grid-template-columns:1fr 1fr;gap:8px}.rep-program-form select{grid-column:1/-1}.rep-program-form span{display:none}.rep-program-form button{grid-column:1/-1}.rep-program-row{grid-template-columns:1fr auto;gap:6px}.rep-program-row small{grid-column:1}.rep-program-row .rep-btn{grid-row:1 / span 2}}
      `}</style>
