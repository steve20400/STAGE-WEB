              ...
              {msg.isDeleted ? (
                ...
                <>
                  ...
                  {msg.type === "audio" && mediaSrc && (
                    <div>
                      {/* ══════ MESSAGERIE VOCALE ══════
                          🔴 CE BANDEAU EST TOUT CE QUI LA DISTINGUE d'un vocal
                          ordinaire, et c'est voulu : c'EST un vocal ordinaire,
                          avec sa lecture, sa duree et son etat lu/non-lu. Seule
                          son origine differe — il a ete laisse apres un appel
                          reste sans reponse, dont la trace est juste au-dessus
                          dans le fil.

                          ⚠️ Absent quand `callId` l'est : un client parlant a un
                          serveur anterieur affiche simplement le vocal, ce qui
                          reste juste. */}
                      {msg.callId && (
                        <div
                          style={{
